...
> 环境变量: `API_5118_KWRANK_MOBILE`
> 介绍页: https://www.5118.com/apistore/detail/f582d2b1-cea2-e711-b5b0-d4ae52d0f72c
...
- **接口地址**: `https://apis.5118.com/keywordrank/baidumobile`
...
- **接口地址**: `https://apis.5118.com/keywordrank/baidumobile`（同步骤一地址）
...
```bash
curl -X POST "https://apis.5118.com/keywordrank/baidumobile" \
  -H "Authorization: 你的APIKEY" \
  -d "keywords=SEO优化&checkrow=50"
```
