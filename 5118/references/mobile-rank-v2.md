...
> 环境变量: `API_5118_MOBILE_V2`
> 介绍页: https://www.5118.com/apistore/detail/8ef3d6ed-2b12-ed11-8da8-e43d1a103141

## 基本信息

- **接口地址**: `https://apis.5118.com/keyword/mobile/v2`
- **请求方式**: POST
    ...
    "baidumobile": [
      {
        "keyword": "关键词",
        "rank": 3,
        "page_url": "https://m.example.com/page",
        "page_title": "网页标题",
        "bidword_companycount": 12,
...
```bash
curl -X POST "https://apis.5118.com/keyword/mobile/v2" \
